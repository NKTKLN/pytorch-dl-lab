...
- `karpathy-coder` — code-quality validation before the PR
- `commit` — the message format and Git Flow rules for landing the work
- `docstrings` — the convention for the new public functions in `src/app`
```
...
- **OpenAI — Codex documentation** (https://developers.openai.com/codex/) — session continuity guidance
