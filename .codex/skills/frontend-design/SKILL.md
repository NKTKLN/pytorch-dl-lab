...
description: >-
  ...
  reshaping an existing one. Use for aesthetic direction, typography, palette and
  layout — the choices that decide whether a page reads as considered or as a
  templated default. Not for wiring behaviour or state.
metadata:
  short-description: Deliberate visual design direction
---

# Frontend Design

> Licensed under Apache 2.0; complete terms in [LICENSE.txt](LICENSE.txt).
